...
- **[faster-whisper](https://github.com/SYSTRAN/faster-whisper)** ⭐ — Быстрая локальная расшифровка речи в текст с тайм-кодами. Бесплатно и офлайн — для субтитров и разбора видео. · `Python` · ★ 13k
...
- **[claude-code-router](https://github.com/musistudio/claude-code-router)** ⭐ — Перенаправляет Claude Code на другие модели — дешёвые или локальные. Гибкость и экономия. · `TypeScript` · ★ 34.7k
- **[numpy](https://github.com/numpy/numpy)** — [Перевод] Claude против краевых случаев: как LLM-агент нашёл баги в NumPy и других Python-библиотеках · `Python` · ★ 32.2k
...
- **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** — MCP-сервер прямо внутри 1С: даёт ИИ-ассистенту (Claude, Cursor) читать и дёргать данные 1С через стандартный протокол. Открытый, MIT. · `1C Enterprise` · ★ 428
...
- **[playwright](https://github.com/microsoft/playwright)** ⭐ — Браузерная автоматизация и тестирование от Microsoft. Движок под нашим парсингом и автоматизацией. · `TypeScript` · ★ 90.2k
...
- **[browserytools](https://github.com/aghyad97/browserytools)** ⭐ — 136+ браузерных инструментов для работы и разработки. Всё локально, без сервера. · `TypeScript` · ★ 405
...
- **[MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)** — AI-фабрика коротких видео: из темы/промпта собирает ролик — сценарий, футажи, озвучка, субтитры. Один клик. · `Python` · ★ 79.8k
- **[Understand-Anything](https://github.com/Lum1104/Understand-Anything)** — Превращает любую тему в обучающие графы-объяснения — «графы, которые учат, а не впечатляют». · `TypeScript` · ★ 52.5k
- **[twenty](https://github.com/twentyhq/twenty)** — Открытая альтернатива Salesforce — современная CRM, которую можно поднять у себя. · `TypeScript` · ★ 49.1k
- **[Magic Resume](https://github.com/JOYCEQL/magic-resume)** — Бесплатный онлайн-редактор резюме с ИИ. Полезно фрилансерам. · `TypeScript` · ★ 8.4k
- **[MOSS-TTS](https://github.com/OpenMOSS/MOSS-TTS)** — MOSS-TTS — открытое семейство моделей синтеза речи от команды MOSS. · `Python` · ★ 3.1k
